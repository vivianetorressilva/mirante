...
### CrewAI
Agente Analyzer (agents.yaml)
    analysa o código python recebido como entrada e sugere melhorias ou correções
Tarefa Analyzer_task (task.yaml)
    tarefa realizada pelo agente Analyzer para sugerir melhorias ou correções
